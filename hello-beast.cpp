//------------------------------------------------------------------------------
// Created from HTTP server small example of https://github.com/boostorg/beast
//------------------------------------------------------------------------------
...
private:
	...
	void create_response()
	{
		if (request_.target() == "/") 
		{
			...
			beast::ostream(response_.body()) << "{\"message\":\"Hello World\"}";
		}
		else
		{
...
int main(int argc, char* argv[])
{
	try
	{
		...
		std::cout << "Listening on http://" << address.to_string() << ":" << std::to_string(port) << "/" << std::endl;
